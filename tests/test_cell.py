...
def test_get_volume(setup_blender):
    cell = setup_blender
    volume = cell.volume()
...
def test_get_cell_name(setup_blender):
    cell = setup_blender
    name = cell.name
    expected_name = "A1"
...
def test_get_type_name(setup_blender):
    cell = setup_blender
...
def test_get_cell_number(setup_blender):
    cell = setup_blender
    type = cell.celltype
...
def test_homotypic_adhesion_strength(setup_blender):
    cell = setup_blender
...
def test_cell_stiffness(setup_blender):
    cell = setup_blender
...
def test_update_cell_stiffness(setup_blender):
    cell = setup_blender
    cell.stiffness = 10
    stiffness = cell.stiffness
...
def test_cell_pressure(setup_blender):
    cell = setup_blender
...
def test_update_cell_pressure(setup_blender):
    cell = setup_blender
    cell.pressure = 10
    pressure = cell.pressure
...
def test_motion_strength(setup_blender):
    cell = setup_blender
...
def test_updated_motion_strength(setup_blender):
    cell = setup_blender
...
def test_cell_material(setup_blender):
    cell = setup_blender
...
def test_update_cell_material(setup_blender):
    cell = setup_blender
...
def test_disable_enable_physics(setup_blender):
    cell = setup_blender
