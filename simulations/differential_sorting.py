...
# Define cell A2
goo.make_cell("cell_A2", loc=(0, 3, 0), type="cellsA")
# Define cell A3
goo.make_cell("cell_A3", loc=(5, 3, 0), type="cellsA")
# Define cell A4
goo.make_cell("cell_A4", loc=(0, -3, 0), type="cellsA")
# Define cell A5
goo.make_cell("cell_A5", loc=(5, -3, 0), type="cellsA")

# Define cell A6
goo.make_cell("cell_A6", loc=(0, 0, 3), type="cellsA")
# Define cell A7
goo.make_cell("cell_A7", loc=(5, 0, 3), type="cellsA")
# Define cell A8
goo.make_cell("cell_A8", loc=(3, 3, 3), type="cellsA")
# Define cell A9
goo.make_cell("cell_A9", loc=(3, -3, 3), type="cellsA")

# Define cell A10
goo.make_cell("cell_A10", loc=(0, 0, -3), type="cellsA")
# Define cell A11
goo.make_cell("cell_A11", loc=(5, 0, -3), type="cellsA")
# Define cell A12
goo.make_cell("cell_A12", loc=(3, 3, -3), type="cellsA")
# Define cell A13
goo.make_cell("cell_A13", loc=(3, -3, -3), type="cellsA")
...
# Define cell B2
goo.make_cell("cell_B2", loc=(5, 0, 0), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B3
goo.make_cell("cell_B3", loc=(3, 3, 0), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B4
goo.make_cell("cell_B4", loc=(3, -3, 0), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B5
goo.make_cell("cell_B5", loc=(3, 0, -3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B6
goo.make_cell("cell_B6", loc=(0, 3, -3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B7
goo.make_cell("cell_B7", loc=(5, 3, -3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B8
goo.make_cell("cell_B8", loc=(0, -3, -3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B9
goo.make_cell("cell_B9", loc=(5, -3, -3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B10
goo.make_cell("cell_B10", loc=(3, 0, 3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B11
goo.make_cell("cell_B11", loc=(0, 3, 3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B12
goo.make_cell("cell_B12", loc=(5, 3, 3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B13
goo.make_cell("cell_B13", loc=(0, -3, 3), material=('red', 0.2, 0, 0), type="cellsB")
# Define cell B14
goo.make_cell("cell_B14", loc=(5, -3, 3), material=('red', 0.2, 0, 0), type="cellsB")
...
handlers.launch_simulation(start=1,  # default, 1
                           ...
                           filepath="/Users/antoine/Harvard/MegasonLab/GPU_backup/AntoineRuzette/goo/data/adhesion-based-sorting/20240402_adhesion_sorting_27cells_1/20240402_adhesion_sorting_27cells_1", 
