...
# Define cell A2
cA2 = goo.Cell("cell_A2", loc = (0,2,0))
# Make a Blender mesh object for cell
goo.make_cell(cA2)
# The created cell is the active object
obj = bpy.context.active_object
...
for collection in bpy.data.collections:
    ...
    if 'Cells' in collection.name_full:
        ...
        for obj in collection.objects:
            ...
            obj.modifiers['Cloth'].settings.air_damping = 500
...
handlers.strength = force_strength
handlers.falloff = force_falloff
handlers.frame_interval = [1,50]
...
handlers.data_file_path = f"C:\\Users\\anr9744\\Projects\\Goo\\data\\TEST_doublets_s{force_strength}f{force_falloff}stiff1damp25visc500"
bpy.app.handlers.frame_change_post.append(handlers.timing_init_handler)
bpy.app.handlers.frame_change_post.append(handlers.data_handler)
